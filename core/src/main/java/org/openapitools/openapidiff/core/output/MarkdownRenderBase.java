...
abstract class MarkdownRenderBase implements Render {
  private static final Logger LOGGER = LoggerFactory.getLogger(MarkdownRenderBase.class);
  ...
  public abstract String getH4();

  public abstract String getH5();

  public abstract String getH6();

  public abstract String getBlockQuote();

  public abstract String getCode();

  public abstract String getPreListItem();

  public abstract String getListItem();

  public abstract String getHorizontalRule();
  ...
  protected String itemResponse(String code, ChangedResponse response) {
    ...
    if (response.getContent() != null) {
      sb.append(this.bodyContent(getListItem(), response.getContent()));
    }
    return sb.toString();
  }
  ...
  protected String blockquote(String beginning) {
    return beginning + getBlockQuote();
  }
